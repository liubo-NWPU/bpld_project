...
import com.geovis.web.dao.system.mapper.*;
...
public class UserServiceImpl extends AbstractService<SysUser> implements UserService{
    ...
    private static SimpleDateFormat rootPathFormate = new SimpleDateFormat("yyyy/MM/");     //普通文件的上传目录
    ...
    public List<SysUser> listAll(SysUser sysUser){
        ...
        Date startDate = sysUser.getStartTime();
        if (startDate != null) {
            criteria.andGreaterThanOrEqualTo("createDate", startDate);
        }

        Date endDate = sysUser.getEndTime();
        if (endDate != null) {
     ...
     */
    @Caching(put = {
            @CachePut(value=SystemCacheUtil.CACHE_USER , key="T(com.geovis.core.util.SystemCacheUtil).SYS_USER_USERNAME + #sysUser.username", condition = "#sysUser.username != null"),
            @CachePut(value=SystemCacheUtil.CACHE_USER , key="T(com.geovis.core.util.SystemCacheUtil).SYS_USER_ID + #sysUser.id", condition = "#sysUser.id != null"),
            @CachePut(value=SystemCacheUtil.CACHE_USER , key="T(com.geovis.core.util.SystemCacheUtil).SYS_USER_OPENID + #sysUser.openid", condition = "#sysUser.openid != null"),
            @CachePut(value=SystemCacheUtil.CACHE_USER
                    , key="T(com.geovis.core.util.SystemCacheUtil).SYS_USER_USERNAME + T(com.geovis.core.util.SystemCacheUtil).getUserById(#sysUser.id)?.getUsername()"
                    , condition = "#sysUser.id != null and #sysUser.username == null"),
            @CachePut(value=SystemCacheUtil.CACHE_USER
                    , key="T(com.geovis.core.util.SystemCacheUtil).SYS_USER_ID + T(com.geovis.core.util.SystemCacheUtil).getUserByUsername(#sysUser.username)?.getId()"
    ...
    @Cacheable(value = SystemCacheUtil.CACHE_USER, key = "T(com.geovis.core.util.SystemCacheUtil).SYS_USER_USERNAME + #username")
    @Override
    ...
    @Cacheable(value = SystemCacheUtil.CACHE_USER, key = "T(com.geovis.core.util.SystemCacheUtil).SYS_USER_OPENID + #openid")
    @Override
     ...
     * @return
     */
    @Cacheable(value = SystemCacheUtil.CACHE_USER, key = "T(com.geovis.core.util.SystemCacheUtil).SYS_USER_ID + #userId")
    @Override
    ...
    @Caching(
            evict = {
                    @CacheEvict(value=SystemCacheUtil.CACHE_USER
                            , key="T(com.geovis.core.util.SystemCacheUtil).SYS_USER_USERNAME + T(com.geovis.core.util.SystemCacheUtil).getUserById(#userId)?.getUsername()"),
                    @CacheEvict(value=SystemCacheUtil.CACHE_USER , key="T(com.geovis.core.util.SystemCacheUtil).SYS_USER_ID + #userId"),
                    @CacheEvict(value=SystemCacheUtil.CACHE_RESOURCE , key="T(com.geovis.core.util.SystemCacheUtil).SYS_USER_ID + #userId"),
                    @CacheEvict(value=SystemCacheUtil.CACHE_RESOURCE , key="T(com.geovis.core.util.SystemCacheUtil).SYS_USER_FOLDER + #userId"),
                    @CacheEvict(value=SystemCacheUtil.CACHE_RESOURCE , key="T(com.geovis.core.util.SystemCacheUtil).SYS_USER_SERVICE_FOLDER + #userId"),
                    @CacheEvict(value=SystemCacheUtil.CACHE_ROLE , key="T(com.geovis.core.util.SystemCacheUtil).SYS_USER_ID + #userId"),
                    @CacheEvict(value=SystemCacheUtil.CACHE_ORG , key="T(com.geovis.core.util.SystemCacheUtil).SYS_USER_ID + #userId")
            })
    @Override
