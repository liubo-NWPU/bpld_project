...
import com.geovis.web.dao.system.mapper.SysDictMapper;
...
public class DictServiceImpl extends AbstractService<SysDict> implements DictService {
    ...
    @CachePut(value = SystemCacheUtil.CACHE_DICT,
            key = "T(com.geovis.core.util.SystemCacheUtil).SYS_DICT_TC + #sysDict.type + #sysDict.code",
     ...
     * @return
     */
    @Cacheable(value = SystemCacheUtil.CACHE_DICT, key = "T(com.geovis.core.util.SystemCacheUtil).SYS_DICT_TC + #type + #code")
    @Override
     ...
     * @return
     */
    @Cacheable(value = SystemCacheUtil.CACHE_DICT, key = "T(com.geovis.core.util.SystemCacheUtil).SYS_DICT_TYPE + #type")
    @Override
