...
//    }
	...
	public static void main(String[] args) {
		String a ="name=th+%282%29.jpg&fileSize=6474&lastModified=1530177714413&fileType=5&parentId=22&userId=0";
		JSONObject j =  transObject(a);
		System.out.println(JSON.toJSONString( j));
	}
	
	
	public static JSONObject transObject(String request) {
		...
		try {
			...
			for (String pair : pairs) {
				...
				if (keyAndValue.length == 2) {
					...
					object.put(key.trim(), (value == null || "".equals(value)) ? null : value.trim());
				}
