...
public class StatelessAuthcFilter extends AccessControlFilter {
    ...
    /*private String[] defalutExcludeUrl = new String[]{
           "/websocket", "/logout", "/login", "/login3", ".jpg", ".png", ".gif", ".css", ".js", ".jpeg", "/currentUserNum", "/login/**", "/anon/**","/downloadDispather/**"
    };*/
    private String[] defalutExcludeUrl = new String[]{
            "/websocket", "/logout", "/login", "/login3", ".jpg", ".png", ".gif", ".css", ".js", ".jpeg", "/currentUserNum", "/login/**", "/anon/**","/getImage","/mrp","/deleteFolder"
    };
    ...
    public boolean include(HttpServletRequest request) {
        ...
        for (String e : defalutExcludeUrl) {
            if (e.endsWith("/**")) {//如果e以/**结束
                String s = e.replace("/**", "");
                if (u.startsWith("/system" + s)) {//如果u以e开始
                    return true;
                }
            }
            if (u.endsWith(e)) {
