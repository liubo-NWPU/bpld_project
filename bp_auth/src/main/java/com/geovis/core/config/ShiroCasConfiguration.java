...
import com.geovis.core.shiro.StatelessRealm;
import com.geovis.web.dao.system.mapper.SysUserMapper;
...
public class ShiroCasConfiguration {
    ...
    public StatelessRealm myShiroCasRealm(EhCacheManager cacheManager) {
...
//    bean.setName(""); //默认为bean name
    ...
    public DefaultWebSecurityManager getDefaultWebSecurityManager(StatelessRealm myShiroCasRealm) {
...
//   <!-- 用户授权/认证信息Cache, 采用EhCache 缓存 -->
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager, CasFilter casFilter, SysUserMapper userDao) {
     ...
     * @create 2016年1月14日
     */
    private void loadShiroFilterChain(ShiroFilterFactoryBean shiroFilterFactoryBean, SysUserMapper userDao) {
        /////////////////////// 下面这些规则配置最好配置到配置文件中 ///////////////////////
