...
import com.gis.trans.tiles3d.concurrent.PntcTileCreator;
...
public class PntcTileCreatorFactory implements WorkerFactory<com.gis.trans.tiles3d.concurrent.PntcTileWork> {
	...
	public Worker<PntcTileWork> createWorker() {
		com.gis.trans.tiles3d.concurrent.PntcTileCreator pntcTilesetCreator = null;
