...
public class GeometryCreator {
    ...
    public LineString createLineByWKT1(String LineStringWKT) throws ParseException {
        WKTReader reader = new WKTReader( geometryFactory );
        LineString line = (LineString) reader.read("LINESTRING(0 0, 3 0)");
        return line;
    }
